...
Das passt hier nicht mehr ergendwie aber kp wohin...
...
Position. SO stehen die Mauer oder auch die Pfeile dort ver
\includegraphics[scale=0.45]{img/level_uml.png}merkt. Es steht auch zu welchem Level gejumpt werden soll wenn 
man auf einen Pfeil kommt. Zusätzlich kann man auch angeben, falls es von einem einzufügenden Objekt mehrere Zeichnnungen hat, dass es diese per Zufall zeichnet. So könnenverschiedene Schätze angezeigt werden, ohne dass wir mehr schreiben müssen.
