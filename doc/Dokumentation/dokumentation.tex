...
Wir kannten zwar Verzweigungen, Schleifen und Funktionen, aber wie können wir damit ein Spiel entwickeln? Im Kopf hatten wir folgende Struktur,
die wir mit der Zeit auch implementiert hatten:\\
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{img/gameloops.png}
\caption{Die Spielarchitektur}
\end{figure}
...
\item ESC gedrückt?
\item Gameover?
\item Alle Schätze eingesammelt?
\end{itemize}

\subsubsection{InputLoop}
Eingaben lesen

\subsubsection{AnimationLoop}
Alle Animationen ausführen

\subsubsection{RenderLoop}
